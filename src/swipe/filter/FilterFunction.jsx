...
export function FilterFunction({ setFilterCondition, filterCondition }) {
  console.log("Filter running");
  const [selectedItems, setSelectedItems] = useState(filterCondition);
...
export function containsInstruments(instrumentsArray, filterArray) {
  ...
  return filterArray.every((filterItem) =>
    instrumentsArray.includes(filterItem)
  );
}
